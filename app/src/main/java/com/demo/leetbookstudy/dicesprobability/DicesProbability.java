package com.demo.leetbookstudy.dicesprobability;
 ...
 *  n=1  1个骰子   1，2，3，4，5，6   每个可能6分之一     6
 *  n=2  2个骰子   1，2，3，4，5，6   2 3 4 5 6 7 345678 456789 5678910 67891011 789101112      11  6的二次方的组合
 *  n=3  3 4
 */
...
//        int zhongjian = size/2+1;
//        if (size%2 == 0){
//
//        }
//        System.out.println("中间："+zhongjian);
//        for (int i = 0; i < size; i++) {
//            if (i>=zhongjian){
//                System.out.println(zhongjian*2-(i));
//                res[i] =  (zhongjian*2-(i+1))/count;
//            }else {
